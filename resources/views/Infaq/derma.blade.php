                ...
                @if (!Auth::check())
                    <div class="pt-2 max-w mx-auto sm:px-6 lg:px-8 space-y-6">
                        <label class = "relative cursor-pointer">
                            ...
                            <span class = "text-white text-opacity-0 absolute left-4 top-7 px-2 transition focus:bg-white  duration-200 input-text">Email</span>
                        </label>
                    </div>
                @endif
                ...
                <div>
                    <div class="pt-4 pb-6 max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                        <label class = "relative cursor-pointer">
                            ...
                            <span class = "text-white text-opacity-0 absolute left-2 top-7 px-2 transition duration-200 input-text">Jumlah Infaq</span>
                        </label>
                    </div>
                    <div class="flex">
